...
window.scenarios = {
  ...
  bath: {
    ...
    phrases: {
      ...
      "2-3": [
        { id:"b21", en:"Can you wash your tummy? Where's your tummy?", zh:"你能洗肚肚吗？肚肚在哪？", tip:"鼓励宝宝自己动手，培养自主性。" },
        { id:"b22", en:"What color is your duck?", zh:"你的小鸭子是什么颜色？", tip:"结合玩具提问，自然地教颜色词汇。" },
        { id:"b23", en:"Close your eyes! Here comes the shampoo!", zh:"闭上眼睛！洗发水来咯！", tip:"提前预告，减少宝宝对洗头的抵触。" },
        { id:"b24", en:"Should we do your hair now? Okay!", zh:"要洗头发了好吗？好！", tip:"给宝宝参与感，减少抵触情绪。" },
        { id:"b25", en:"Are you all clean? Let me check... yes! Squeaky clean!", zh:"洗干净了吗？让我检查……是的！干净啦！", tip:"夸张地检查宝宝的手脚，变成游戏。" },
      ],
      "3-6": [
  ...
  meal: {
    ...
    phrases: {
      ...
      "2-3": [
        { id:"m21", en:"What would you like to eat? Rice or noodles?", zh:"你想吃什么？米饭还是面条？", tip:"给出两个选项，让宝宝练习做选择和表达。" },
        { id:"m22", en:"That's broccoli! Can you say broccoli?", zh:"这是西兰花！你能说西兰花吗？", tip:"鼓励宝宝模仿说新词，不纠正发音，鼓励尝试。" },
        { id:"m23", en:"Yummy! Is it delicious?", zh:"好吃！好吃吗？", tip:"引导宝宝描述感受，建立味道词汇。" },
        { id:"m24", en:"Can you use your spoon?", zh:"你能用勺子吃吗？", tip:"鼓励宝宝自己用工具，哪怕会洒也要鼓励。" },
        { id:"m25", en:"Almost done! Two more bites!", zh:"快吃完了！再吃两口！", tip:"具体数字让宝宝有目标感，比再吃一点更有效。" },
      ],
      "3-6": [
  ...
  bedtime: {
    ...
    phrases: {
      ...
      "2-3": [
        { id:"d21", en:"It's almost bedtime. Let's do five more minutes of playtime.", zh:"快要睡觉了。我们再玩五分钟。", tip:"提前预警比突然终止游戏效果更好，减少哭闹。" },
        { id:"d22", en:"What was your favorite thing today?", zh:"今天你最喜欢什么？", tip:"睡前回顾一天，帮宝宝建立语言表达和情感处理能力。" },
        { id:"d23", en:"Let's count the stars! One, two, three...", zh:"我们数星星！一、二、三……", tip:"看窗外或天花板上的贴纸，把入睡引导变成游戏。" },
        { id:"d24", en:"You had such a good day. I'm proud of you.", zh:"你今天真的很棒。我为你骄傲。", tip:"在宝宝入睡前说正向的话，有助于建立自信心。" },
        { id:"d25", en:"Close your eyes. I'll be right here.", zh:"闭上眼睛。我就在这里。", tip:"给宝宝安全感，减少分离焦虑。" },
      ],
      "3-6": [
  ...
  handwash: {
    ...
    phrases: {
      ...
      "3-6": [
        ...
        { id:"hw32", en:"Germs are tiny and invisible! Soap washes them away!", zh:"细菌很小看不见！皂皂能把它们洗走！", tip:"解释细菌的概念，让孩子理解洗手的科学原理。" },
  ...
  reading: {
    ...
    phrases: {
      "0-1": [
        { id:"rd01", en:"Look at the picture! What's that?", zh:"看这幅图！那是什么？", tip:"手指指向图片，吸引宝宝视线，共同关注是语言的基础。" },
  ...
  potty: {
    ...
    phrases: {
      ...
      "1-2": [
        ...
        { id:"pt12", en:"This is the potty! The potty is for pee pee and poo poo.", zh:"这是小马桶！小马桶是用来尿尿和便便的。", tip:"直接介绍马桶用途，用简单词语不让宝宝感到神秘。" },
  ...
  exercise: {
    ...
    phrases: {
      ...
      "3-6": [
        ...
        { id:"ex35", en:"Moving your body every day keeps you healthy and strong!", zh:"每天运动让你健康强壮！", tip:"建立运动习惯的意识，从小培养对健康生活方式的认识。" },
      ],
    }
  },
